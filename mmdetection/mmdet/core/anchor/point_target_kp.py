...
def point_target_kp(proposals_list,
                    valid_flag_list,
                    gt_bboxes_list,
                    gt_kps_list,
                    img_metas,
...
def point_target_single(flat_proposals,
    ...
    keypoint_gt = proposals.new_zeros([num_valid_proposals, gt_keypoints.size(1), 2])
    keypoint_weights = proposals.new_zeros([num_valid_proposals, gt_keypoints.size(1), 2])
    ...
    return (labels, label_weights, bbox_gt, pos_proposals, proposals_weights,
            keypoint_gt, keypoint_weights, pos_inds, neg_inds)

...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            alpha=0.25,
            loss_weight=1.0),
        loss_bbox_init=dict(type='SmoothL1Loss', beta=0.11, loss_weight=0.5),  # 0.5
        loss_bbox_refine=dict(type='SmoothL1Loss', beta=0.11, loss_weight=1.),  # 1.0
        loss_kpt_init=dict(type='SmoothL1Loss', beta=0.11, loss_weight=2.),  # 2.0
        loss_kpt_refine=dict(type='SmoothL1Loss', beta=0.11, loss_weight=4.),  # 4.0
